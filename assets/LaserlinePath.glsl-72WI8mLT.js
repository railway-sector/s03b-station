import{IA as be,Iw as we,IS as De,GA as f,HM as w,IF as Ve,GB as H,Gx as r,bX as z,xv as ee,Iz as xe,Hq as E,c$ as te,cZ as A,hg as F,IT as Le,hI as ie,HK as ne,H2 as S,f_ as m,cY as v,IU as se,zF as ae,v as o,mj as re,hf as ye,rE as Ee,d0 as Se,db as le,fa as oe,hd as Ce,Ix as Me,xJ as Ae,H0 as $e,HU as Re,Gw as B,c7 as Te,qJ as ce,qL as he,_ as de,g0 as Ie,b_ as G,qc as q,$ as c,a2 as j,jO as pe,g1 as ue,cW as Oe,c_ as O,lq as Ue,Hd as qe,ls as ze,IV as je,GM as V,nZ as Ne,n_ as X,IW as We,mh as He,IX as $,IY as Fe,wy as Z,rA as Be,vd as Ge,rB as Xe,rC as Ze,rD as ke,rF as Je,a1 as C,IZ as Ye,c0 as k}from"./index-qMtTQsR0.js";import{t as Ke}from"./VisualElement-9OmW20VG.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
