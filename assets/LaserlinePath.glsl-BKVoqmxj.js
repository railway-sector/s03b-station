import{IB as be,Ix as we,IT as De,GB as f,HN as w,IG as Ve,GC as H,Gy as r,bX as z,xw as ee,IA as xe,Hr as E,c$ as te,cZ as A,hg as B,IU as Le,hI as ie,HL as ne,H3 as S,f_ as m,cY as v,IV as se,zG as ae,v as o,mj as re,hf as ye,rE as Ee,d0 as Se,db as le,fa as oe,hd as Ce,Iy as Me,xK as Ae,H1 as $e,HV as Re,Gx as F,c7 as Te,qJ as ce,qL as he,_ as de,g0 as Ie,b_ as G,qc as q,$ as c,a2 as j,jO as pe,g1 as ue,cW as Oe,c_ as O,lq as Ue,He as qe,ls as ze,IW as je,GN as V,nZ as Ne,n_ as X,IX as We,mh as He,IY as $,IZ as Be,wz as Z,rA as Fe,vi as Ge,rB as Xe,rC as Ze,rD as ke,rF as Ye,a1 as C,I_ as Je,c0 as k}from"./index-CTgcfdN1.js";import{t as Ke}from"./VisualElement-DRjL107T.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>m(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>m(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=B(D),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/B(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new E("heightPlane",(s,a)=>_e(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
