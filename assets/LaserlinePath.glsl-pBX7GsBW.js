import{Jy as Pe,Ju as be,JZ as we,Hs as f,IJ as w,JA as Ve,Ht as W,Hp as r,fu as z,x0 as Y,Jx as De,Im as C,gc as ee,gd as R,hU as F,J_ as xe,fX as te,IH as ie,H$ as M,gT as m,h2 as v,J$ as ne,zp as se,o,mq as ae,hT as Ee,ic as ye,ge as Le,dc as re,g1 as le,hR as Se,Jv as Ce,xe as Me,HZ as Ae,IR as $e,Ho as B,eh as Re,Hv as oe,Hw as ce,_ as he,pl as Te,e8 as G,id as q,av as c,ay as j,k8 as de,k6 as pe,dh as Ie,db as I,lB as Oe,I8 as qe,lG as Ue,K0 as ze,HK as D,JE as je,JF as J,K1 as He,mo as Ne,K2 as T,K3 as We,i7 as Fe,v5 as Be,i9 as Ge,ia as Je,ib as Ke,ie as ke,ax as A,K4 as Xe,ea as K}from"./index-DSLnFB2e.js";import{t as Ze}from"./VisualElement-B2_uaCgk.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
