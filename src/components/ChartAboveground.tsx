...
import "../App.css";
import {
  buildingLayerCategory_aboveground,
  construction_status,
  generateChartDataAboveground,
...
const ChartAboveground = () => {
  ...
  useEffect(() => {
    generateChartDataAboveground().then((response: any) => {
  ...
  useEffect(() => {
    ...
    function makeSeries(name: any, fieldName: any) {
      ...
      series.columns.template.events.on("click", (ev) => {
        ...
        if (categorySelect === buildingLayerCategory_aboveground[0]) {
        ...
        } else if (categorySelect === buildingLayerCategory_aboveground[1]) {
          ...
          stairsRailingLayer.visible = false;
          exteriorShellLayer.visible = false;
        } else if (categorySelect === buildingLayerCategory_aboveground[2]) {
          stFoundationLayer.visible = false;
          ...
          stairsRailingLayer.visible = false;
          exteriorShellLayer.visible = false;
        } else if (categorySelect === buildingLayerCategory_aboveground[3]) {
          stFoundationLayer.visible = false;
          stFramingLayer.visible = true;
          stColumnLayer.visible = true;
          floorsLayer.visible = false;
...
export default ChartAboveground;
